function secondviz(directoryname)
{
  var units = "",curr_emo="null",chapter_arr,curr_nodeno = "null";
  ...
  var formatNumber = d3.format(",.0f"),    // zero decimal places
      ...
      color =  ["#CCCC00", "#A52A2A", "#808000","#FF4500", "#ff1919","#800080","#001933","#0337ff"],
  ...
  var generateData= function(directoryname){
    ...
    d3.json(directoryname + "third.json",function(data) {
      ...
      var chapter = new Array(resources[0]["chap_sentiment"].length);
      ...
      for(var i=0;i<resources.length;i++)
      {
        ...
        var ignoreList=["Emerald","City","Oh","Cowardly"]
  ...
  // add in the links
    var viz3link = svg.selectAll(".viz3link").append("g")
        .data(graph.links)
      .enter().append("g")
              .attr("class", "viz3link");
  ...
  // add in the nodes
    var viz3node = svg.append("g").selectAll(".thirdnode")
        .data(graph.nodes)
      .enter().append("g")
  ...
  //the on click function
    function onNodeClick(d){
      ...
      force_call(forcedata,directoryname,chapter_arr,emotion_dict,curr_emo,curr_nodeno);       
