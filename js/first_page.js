...
d3.json("Data/img.json",function(d){
    ...
    var imgs = images.append("svg:image")
        ...
        .attr('x',function(d,i){return (width - 200) - i%10 * (image_width + 15);})
        .attr('y',function(d,i){return (height - 100) - Math.floor(i/10) * (image_height + 15);})
    ...
    var setevents = d3.selectAll('.imgs').on('mouseenter',function(d){
        ...
        function imageclick(d){
            ...
            selected_imgdir = "Data/Json_Data/604/";
